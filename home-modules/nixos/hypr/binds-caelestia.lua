...
exec(main_mod .. " + SHIFT + P", "caelestia shell drawers toggle launcher")
exec(main_mod .. " + V", "caelestia clipboard")
exec(main_mod .. " + comma", "caelestia shell drawers toggle session")
exec(main_mod .. " + period", "caelestia emoji -p")
exec(main_mod .. " + CTRL + escape", "caelestia shell lock lock")
exec(main_mod .. " + CTRL + Q", "caelestia shell drawers toggle sidebar")
